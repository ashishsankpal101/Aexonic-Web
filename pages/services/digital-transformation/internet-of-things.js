  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Aexonic : Services / Internet of Things</title>
      </Head>
              ...
              <div className="row justify-content-center ">
                ...
                >
                  ...
                  <h6 className="subtitle op-8 banner-text">
                    Our IoT solutions help you optimize your productivity and
            ...
            <div className="container">
              <div className="row justify-content-center">
                <div className="col-md-7 text-center">
                  <h2 className="title"> Impact of IoT on Your Organization</h2>
                  <h6 className="subtitle">
                    IoT implementations and IoT-based systems help you scale
                    your business verticals across horizons and experience
                    better results.
                  </h6>
                </div>
              </div>
              <div className="row wrap-feature-22">
                ...
                <div className="col-lg-6">
                  <div className="text-box mt-5">
                    <p>
                      IoT is transforming the way businesses operate in a
                      tech-first world.
                    </p>
                    <p>
                      Businesses across industries have automated various
                      operations by inserting sensors, communication devices,
                      and identity chips with cloud and analytics engines. This
                      has benefited them by unlocking massive opportunities that
                      digital transformation promises.
                    </p>
                    <p>
                      We at Aexonic have helped our clients leverage the power
                      of IoT across the industry. We can help you too!
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  <img
                    src="https://img.freepik.com/free-vector/development-service-smart-house-iot-technology-network-programming_335657-3149.jpg?w=900&t=st=1666098103~exp=1666098703~hmac=13e4a32c957a983752f9af88c7ce497919729793f212928b7073e4c1a9381c19"
            ...
            <div className="container">
              <div className="row justify-content-center">
                <div className="col-md-7 text-center">
                  ...
                  <h6 className="subtitle">
                    Tap on the omni-and-multi-channel services by incorporating
                    IoT as per your customer&apos;s demands at scale, with
                  ...
                  >
                    <div className="card-body d-flex">
                      ...
                      <div className="align-self-center">
                        ...
                        <p className="m-t-20">
                          Tap on the omni-and-multi-channel services by
                          incorporating IoT as per your customer&apos;s demands
                          at scale, with extensive automation.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="card-body d-flex">
                      ...
                      <div className="align-self-center">
                        ...
                        <p className="m-t-20">
                          Monitor products to create a better line of products
                          with actionable analytics building a single source of
                          reference for data searching.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="card-body d-flex">
                      ...
                      <div className="align-self-center">
                        ...
                        <p className="m-t-20">
                          With its flexible and scalable infrastructure, IoT
                          ensures devices work smoothly in the business
                          landscape.
                        </p>
                      </div>
                    </div>
                  ...
                  >
                    <div className="card-body d-flex">
                      ...
                      <div className="align-self-center">
                        ...
                        <p className="m-t-20">
                          Transform IoT sensor data into actionable insights and
                          generate more business when strategically planned.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="container">
                ...
                <div className="col-md-6 align-self-center">
                  <div className="max-box">
                    <h2 className="title m-t-20">
                      IoT - A Unique Gateway into Modernizing Workflow
                    </h2>
                    <p className="m-t-30">
                      Our clients who have adopted IoT have experienced new
                      horizons in availing of opportunities that make them
                      become the leader of their industries. Businesses that
                      integrate IoT devices make it to the top of evolving
                      trends and experience better customer engagement and
                      retention.
                    </p>
                    <p>
                      Become a recognized name in your industry by employing
                      high-tech solutions.
                    </p>
                    {/* <a href="" className="linking">Learn More <i className="ti-arrow-right"></i></a> */}
                  </div>
                </div>
                <div className="col-md-5 col-md-5 ml-auto ">
                  <img
                    src="https://img.freepik.com/premium-vector/illustration-vector-graphic-cartoon-character-online-business_516790-19.jpg?w=740"
                    alt="wrapkit"
              ...
              <div className="row wrap-feature-26 m-t-40 p-t-30">
                <div className="col-md-5">
                  <img
                    src="https://img.freepik.com/free-vector/internet-day-concept-illustration_114360-5303.jpg?w=740&t=st=1666153167~exp=1666153767~hmac=6962b78dd69d4e77abd3c14d652286cf4ae1aa88c28d2fd6647cf4454a65807e"
                    alt="wrapkit"
                    className="img-responsive"
                  />
                </div>
                <div className="col-md-6 ml-auto align-self-center">
                  <h2 className="title m-t-20">
                    IoT - Helping You Predict Shifts & Trends Before They Happen
                  </h2>
                  <p className="m-t-30">
                    Advanced IoT solutions enhance the customer experience by
                    personalizing it based on past experiences and integrated
                    connectivity like devices, data, people, and processes.
                  </p>
                  <p>
                    When you have past data with you, analyzing customers&apos;
                    behaviors on how they act and respond becomes easier, and
                    that helps you deliver useful and better products.
                  </p>
            ...
            <div className="container">
              <div className="row justify-content-center">
                <div className="col-md-7 text-center">
                  ...
                  <h6 className="subtitle">
                    Our IoT solutions guarantee a better customer experience
                    that gives you a competitive advantage and increases your
                    revenue metrics.
                  </h6>
                </div>
              </div>
              ...
              <div className="row m-t-40">
                <div className="col-md-4 wrap-feature2-box">
                  ...
                  >
                    <img
                      ...
                      src="https://img.freepik.com/free-photo/young-handsome-physician-medical-robe-with-stethoscope_1303-17818.jpg?w=900&t=st=1666155997~exp=1666156597~hmac=d48b6b757038239705777862eb1505a3fb229fc783e4793fdb6e15d719233e46"
                      alt="wrappixel kit"
                    />
                    <div className="card-body text-center">
                      <h5 className="font-medium">IoT In Healthcare</h5>
                      <p className="m-t-20">
                        Our IoT Healthcare solutions offer clinicians,
                        hospitals, and pharmacies, secure medical care
                        infrastructure and allow them to deliver superior care
                ...
                <div className="col-md-4 wrap-feature2-box">
                  ...
                  >
                    <img
                      className="card-img-top"
                      src="https://img.freepik.com/free-photo/e-commerce-shop-online-homepage-sale-concept_53876-127542.jpg?t=st=1666155610~exp=1666156210~hmac=a4b0f07104ed5fde294142fc8a018d53de5fcf45e8e97d416a4fc46a25042640"
                      alt="wrappixel kit"
                    />
                    <div className="card-body text-center">
                      <h5 className="font-medium">IoT In Retail</h5>
                      <p className="m-t-20">
                        Deliver connected retail experiences with retail IoT
                        solutions by Mindbowser. We enable you to leverage
                        sensors like beacons to create a more compelling
                ...
                <div className="col-md-4 wrap-feature2-box">
                  ...
                  >
                    ...
                    />
                    <div className="card-body text-center">
                      <h5 className="font-medium">IoT In Logistics</h5>
                      <p className="m-t-20">
                        We develop IoT enabled applications that allow on-demand
                        fleet management to increase efficiency for the
                        Logistics industry. Sensors can provide critical data
                        from the vehicles that can help to manage their path.
                      </p>
                    </div>
                  </div>
                </div>

                              ...
                              <li className="nav-item dropdown">  <Link href="/industry"><a className="nav-link dropdown-toggle active" id="h6-dropdown2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                 ...
                                 <ul className="b-none dropdown-menu font-14 animated fadeInUp">
                                    ...
                                    <li> <Link href="/industries/hospitality">
                                       <a className="dropdown-item active_menu">Hospitality and Travel</a>
                                    </Link>
                                    </li>
                        ...
                        <div className="col-lg-6">
                           <div className="row wrap-feature-12">
                              <div className="col-md-6">
                                 <div className="row">
                                    <div className="col-md-12"><img src="/images/features/feature12/img1.jpg" className="rounded img-shadow img-responsive" alt="wrapkit" /></div>
                                    <div className="col-md-12"><img src="/images/features/feature12/img2.jpg" className="rounded img-shadow img-responsive" alt="wrapkit" /></div>
                                 </div>
                              </div>
                              <div className="col-md-6 uneven-box">
                                 <div className="row">
                                    <div className="col-md-12"><img src="/images/features/feature12/img3.jpg" className="rounded img-shadow img-responsive" alt="wrapkit" /></div>
                                    <div className="col-md-12"><img src="/images/features/feature12/img4.jpg" className="rounded img-shadow img-responsive" alt="wrapkit" /></div>
                                 </div>
                              </div>
                           </div>
                        </div>
                     ...
                     <div className="row text-white">
                        ...
                        <div className="col-md-5 both-space">
                           <div className="" data-aos="fade-right" data-aos-duration="1200">
                              ...
                              <p className="op-8">You can relay on our amazing features list and also our customer services will be great experience.</p> </div>
                        </div>
                     </div>
                  </div>
               </div>
                     ...
                     <div className="row m-t-40">
                        ...
                        <div className="col-lg-6 wrap-feature13-box">
                           <div className="card card-shadow" data-aos="fade-right" data-aos-duration="1200">
                              <ul className="img-inline">
                                 <li className="half-width"><img src="/images/features/f13/img1.jpg" alt="wrapkit" className="img-responsive rounded" /></li>
                                 <li className="p-20 half-width">
                                    <h5 className="font-medium m-t-10"><a className="linking">Instant Solutions <i className="ti-arrow-right"></i></a></h5>
                                    <p className="m-t-20">You can relay on our amazing features list and also our customer.</p>
                                 </li>
                              </ul>
                           </div>
                        </div>
                        ...
                        <div className="col-lg-6 wrap-feature13-box">
                           <div className="card card-shadow" data-aos="fade-left" data-aos-duration="1200">
                              <ul className="img-inline">
                                 <li className="half-width"><img src="/images/features/f13/img2.jpg" alt="wrapkit" className="img-responsive rounded" /></li>
                                 <li className="p-20 half-width">
                                    <h5 className="font-medium m-t-10"><a className="linking">Instant Solutions <i className="ti-arrow-right"></i></a></h5>
                                    <p className="m-t-20">You can relay on our amazing features list and also our customer.</p>
                                 </li>
                        ...
                        <div className="col-lg-6 wrap-feature13-box">
                           <div className="card card-shadow" data-aos="fade-right" data-aos-duration="1200">
                              <ul className="img-inline">
                                 <li className="half-width"><img src="/images/features/f13/img3.jpg" alt="wrapkit" className="img-responsive rounded" /></li>
                                 <li className="p-20 half-width">
                                    <h5 className="font-medium m-t-10"><a className="linking">Instant Solutions <i className="ti-arrow-right"></i></a></h5>
                                    <p className="m-t-20">You can relay on our amazing features list and also our customer.</p>
                                 </li>
                        ...
                        <div className="col-lg-6 wrap-feature13-box">
                           <div className="card card-shadow" data-aos="fade-left" data-aos-duration="1200">
                              <ul className="img-inline">
                                 <li className="half-width"><img src="/images/features/f13/img4.jpg" alt="wrapkit" className="img-responsive rounded" /></li>
                                 <li className="p-20 half-width">
                                    <h5 className="font-medium m-t-10"><a className="linking">Instant Solutions <i className="ti-arrow-right"></i></a></h5>
                                    <p className="m-t-20">You can relay on our amazing features list and also our customer.</p>
                                 </li>

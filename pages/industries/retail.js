                                        ...
                                        <li className="nav-item dropdown">  <Link href="/industry"><a className="nav-link active dropdown-toggle" id="h6-dropdown2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            ...
                                            <ul className="b-none dropdown-menu font-14 animated fadeInUp">
                                                ...
                                                <li> <Link href="/industries/retail">
                                                    <a className="dropdown-item active_menu">Retail and e-commerce</a>
                                                </Link>
                                                </li>
                            ...
                            <div className="container">
                                <div className="col-lg-6">
                                    <div className="" data-aos="fade-right" data-aos-duration="1200">
                                        ...
                                        <p className="op-8">You can relay on our amazing features list and also our customer services will be great experience.</p>
                                    </div>
                                    <div className="row m-t-30" data-aos="fade-right">
                                        <div className="col-md-4">
                                            <div className="card card-shadow">
                                                <div className="card-body text-center text-uppercase"> <i className="icon-Car-Wheel display-5 text-success"></i>
                                        ...
                                        <div className="col-md-4">
                                            <div className="card card-shadow">
                                                <div className="card-body text-center text-uppercase"> <i className="icon-Mouse-3 display-5 text-success"></i>
                                        ...
                                        <div className="col-md-4">
                                            <div className="card card-shadow">
                                                <div className="card-body text-center text-uppercase"> <i className="icon-Target display-5 text-success"></i>
                                ...
                                <div className="col-lg-6 right-image">
                                    <img src="/images/retail_1.jpg" className="half-radius" alt="wrappixel" data-aos="fade-left" data-aos-duration="3000" data-aos-offset="500" />
                                </div>
                            </div>
                        </div>
                    </div>

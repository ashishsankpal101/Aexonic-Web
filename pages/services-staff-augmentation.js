...
const ServiceStaffAugumentation = () => {
  return (
    <div>
      <Head>
        <meta charSet="utf-8" />
        ...
        />
        <title>Aexonic : Staff Augmentation</title>
      </Head>
          ...
          >
            <div className="container">
              ...
              <div className="row justify-content-center ">
                ...
                >
                  <h1 className="title banner-text">Staff Augmentation</h1>
...
export default ServiceStaffAugumentation;

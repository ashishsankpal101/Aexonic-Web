...
const Serviceenterpricesolutions = () => {
  return (
    <div>
      <Head>
        <meta charSet="utf-8" />
        ...
        />
        <title>Aexonic : Enterprise Solutions</title>
      </Head>
          ...
          >
            <div className="container">
              ...
              <div className="row justify-content-center ">
                ...
                >
                  <h1 className="title banner-text">Enterprise Solutions</h1>
              ...
              <div className="container">
                  ...
                  <div className="col-md-6 align-self-center">
                    <div className="max-box">
                      ...
                      <p className="m-t-30">
                        ...
                        customer services will be greatexperience for you
                        without doubt and in no-time and with great quality for
                        design.
                      </p>
                      <p>
                        We guarantee you with our WrapKit that you will make
                        your site in record time and it will be fun to work on.
                      </p>
                ...
                <div className="row wrap-feature-26 m-t-40 p-t-30">
                  ...
                  <div className="col-md-6 ml-auto align-self-center">
                    <h2 className="title m-t-20">
                      We help you utilize a complete full-service development
                    </h2>
                    <p className="m-t-30">
                      You can relay on our amazing features list and also our
                    ...
                    <p>
                      We guarantee you with our WrapKit that you will make your
                      site in record time and it will be fun to work on.
                    </p>
                ...
                <div className="row m-t-40">
                    ...
                    >
                      <div className="card-body d-flex">
                        <div className="icon-space align-self-center">
                          <i className="icon-Double-Circle display-2 text-info-gradiant"></i>
                        </div>
                  ...
                  <div className="col-md-6 wrap-feature3-box">
                    ...
                    >
                      <div className="card-body d-flex">
                        <div className="icon-space align-self-center">
                          <i className="icon-Stopwatch display-2 text-info-gradiant"></i>
                        </div>
                        <div className="align-self-center">
                          <h5 className="font-medium">
                            <a href="" className="linking">
                  ...
                  <div className="col-md-6 wrap-feature3-box">
                    ...
                    >
                      <div className="card-body d-flex">
                        <div className="icon-space align-self-center">
                          <i className="icon-Thumbs-UpSmiley display-2 text-info-gradiant"></i>
                        </div>
                        <div className="align-self-center">
                          <h5 className="font-medium">
                            <a href="" className="linking">
                  ...
                  <div className="col-md-6 wrap-feature3-box">
                    ...
                    >
                      <div className="card-body d-flex">
                        <div className="icon-space align-self-center">
                          <i className="icon-Window-2 display-2 text-info-gradiant"></i>
                        </div>
                        <div className="align-self-center">
                          <h5 className="font-medium">
                            <a href="" className="linking">
            ...
            <div className="feature28">
              ...
              <div className="wrap-feature-28 row">
                <div
                  ...
                  style={{ backgroundImage: "url(./images/innerpage/s3.jpg)" }}
                ></div>
                <div className="col-lg-6">
                  <div className="side-content both-space">
                    ...
                    <p>
                      You can relay on our amazing features list and also our
                      customer services will be great experience for you without
                      doubt and in no-time and with great quality.
                    </p>
                    <a
              ...
              <div className="wrap-feature-28 row">
                ...
                <div
                  className="col-lg-6 bg-cover"
                  style={{ backgroundImage: "url(./images/innerpage/s4.jpg)" }}
                ></div>
              </div>
              <div className="wrap-feature-28 row">
                <div
                      ...
                      <div className="card-body">
                        <div className="icon-space">
                          <div className="icon-round bg-success-gradiant">
                            <i className="icon-Business-Man"></i>
                          </div>
                        </div>
                        <h5 className="font-medium">
                          01. Disscussion &amp; Ideas
                        </h5>
                        <p className="m-t-20">
                  ...
                  <div className="col-md-3 wrap-feature11-box">
                    ...
                    >
                      <div className="card-body">
                        <div className="icon-space">
                          <div className="icon-round bg-success-gradiant">
                            <i className=" icon-Chacked-Flag"></i>
                          </div>
                        </div>
                        <h5 className="font-medium">
                          04. Execute &amp; Support
            ...
            <div className="spacer feature24 ">
              <div className="container">
                ...
                <div className="row justify-content-center">
                  ...
                  <div className="col-md-7 text-center">
                    <h2 className="title">
                      More Then 8 Years We Provide IT Solutions Services For You
                    </h2>
                    <h6 className="subtitle">
                      You can relay on our amazing features list and also our
                      customer services will be great experience for you without
                    ...
                    >
                      <div className="card-body">
                        <div className="icon-round bg-light-info">
                          <i className="icon-Clown"></i>
                        </div>
                        <h5 className="font-medium">User Interface Design</h5>
                        <p className="m-t-20">
                          You can relay on our amazing features list and also
                          our customer services will be great experience. Lorem
...
export default Serviceenterpricesolutions;

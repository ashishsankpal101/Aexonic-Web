                ...
                <div className="row justify-content-center">
                  <div className="col-md-8">
                    ...
                    <div className="mini-spacer">
                      <img
                        src="/images/innerpage/blog1.jpg"
                        alt="wrapkit"
                        className="img-fluid"
                      />
                      <ul className="text-uppercase m-t-40 list-inline font-13 font-medium">
                        ...
                        <li>
                          <a className="text-info">&nbsp;NEWS</a>
                        </li>
                      </ul>
                      <h2 className="title font-light">
                        <a className="link">
                          Wrapkit is about to release and we are really very
                          excited about it
                        </a>
                      </h2>
                      <p className="m-t-30 m-b-30">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Duis nec facilisis nullano volutpat justo. Nulla tempus
                        ultricies feugiat. Duis magna risus, luctus id urna
                        dapibus condimentum dui. Maecenas tempor non ex eu
                        vehicula. Sed sit placerat velit,
                      </p>
                      <p className="m-t-30 m-b-30">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Duis nec facilisis nullano volutpat justo. Nulla tempus
                      ...
                      <div className="m-t-40 m-b-10">
                        <i className="display-5 text-muted op-5 fa fa-quote-left"></i>
                      </div>
                      <h3 className="font-light">
                        Aliquam diam quis dolor aliquam lobortis. Aenean in
                        tortor et eros faucibus porta sit amet sed ipsum Nullam
                        hendrerit dui id diam suscipit.
                      </h3>
                      <ul className="list-block m-t-30 m-b-30">
                        <li>
                          <i className="fa fa-circle font-13 text-info"></i> A
                          DP’s most important skill is previsualisation — the
                          difference between taking pictures
                        </li>
                        <li>
                          <i className="fa fa-circle font-13 text-info"></i>{" "}
                          Important asset is the directors who’ll hire
                          them — expand and protect that group
                        </li>
                        <li>
                          <i className="fa fa-circle font-13 text-info"></i>{" "}
                          There will be many days with no work.{" "}
                        </li>
                        <li>
                          <i className="fa fa-circle font-13 text-info"></i>{" "}
                          Your credits list and reputation are far more crucial.
                        </li>
                      </ul>
                      <img
                        src="/images/innerpage/blog2.jpg"
                        alt="wrapkit"
                        className="img-fluid"
                      />
                      <p className="m-t-30 m-b-30">
                      ...
                      <div className="m-t-30">
                        <button
                          type="button"
                          className="btn bg-facebook btn-rounded"
                        ...
                        <button
                          type="button"
                          className="btn bg-twitter btn-rounded"
                        >
                    ...
                    <div className="mini-spacer p-b-0">
                      ...
                      <ul className="list-unstyled with-noborder m-t-30">
                        <li className="media">
                          <img
                            className="d-flex mr-3 img-circle"
                            src="/images/ui/1.jpg"
                            width="60"
                        ...
                        <li className="media">
                          ...
                          <div className="media-body">
                            ...
                            <div className="media">
                              ...
                              <div className="media-body">
                                <h5 className="mt-0">Media heading</h5> Cras sit
                                amet nibh libero, in gravida nulla. Nulla vel
                    ...
                    <div className="mini-spacer">
                      ...
                      <form className="row">
                        ...
                        <div className="form-group col-md-12 m-t-20">
                          <button
                            type="submit"
                            className="btn btn-info waves-effect waves-light m-r-10"
                          >
                            Submit
                          </button>
                        </div>
            ...
            <div className="container ">
              <div className="row ">
                ...
                <div className="col-lg-3 col-md-6 m-b-30 ">
                  ...
                  <p>
                    Office : <a className="link ">info@aexonic.com</a>
                    <br />
                    Site : <a className="link ">http://www.aexonic.com/</a>
                  </p>
                </div>
              ...
              <div className="f4-bottom-bar ">
                <div className="row ">
                  <div className="col-md-12 ">
                    ...
                    >
                      <a className="navbar-brand m-b-11 ">
                        <img
                      ...
                      <div className="collapse navbar-collapse " id="header1 ">
                        ...
                        <ul className="navbar-nav ml-auto mt-2 mt-lg-0 ">
                          ...
                          <li className="nav-item ">
                            <a className="nav-link ">Our Offering</a>
                          </li>
                          <li className="nav-item ">
                          ...
                          <li className="nav-item ">
                            <a className="nav-link active_menu">More</a>
                          </li>
                          <li className="nav-item ">

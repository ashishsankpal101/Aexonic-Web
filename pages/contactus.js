                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-lg-3 col-md-4">
                                                        <ul className="list-style-none">
                                                            <li>
                                                                <h6 className="f-w-500"><span className="fa fa-cogs custom-icon"></span> Product Engineering</h6>
                                                            </li>
                                                    ...
                                                    <div className="col-lg-3 col-md-4">
                                                        <ul className="list-style-none">
                                                            <li>
                                                                <h6 className="f-w-500"><span className="fa fa-sitemap custom-icon"></span> Digital Transformation</h6>
                                                            </li>
                                                    ...
                                                    <div className="col-lg-3 col-md-4">
                                                        <ul className="list-style-none">
                                                            <li>
                                                                <h6 className="f-w-500"><span className="fa fa-users custom-icon"></span> Staff Augmentation</h6>
                                                            </li>
                                                            <li><a target="_blank">Onshore</a></li>
                                                            <li><a target="_blank">Offshore</a></li>
                                                            <li><a target="_blank">Nearshore</a></li>
                                                            <li>
                                                                <h6 className="f-w-500"><span className="fa fa-gear custom-icon"></span> Enterprise Solutions</h6>
                                                            </li>
